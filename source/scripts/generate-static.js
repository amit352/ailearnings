...
const PAGES = [
  ...
  },
  {
    ...
    title:       'AI Engineering Blog – Guides, Tutorials & Roadmaps | AI Learning Hub',
    description: 'AI engineering articles for software developers. Learn LLMs, RAG, prompt engineering, machine learning, and agentic AI with practical guides and tutorials.',
    ...
    schema: [
      {
        '@context': 'https://schema.org',
        '@type': 'Blog',
        name: 'AI Learning Hub Blog',
        url: 'https://ailearnings.in/blog/',
        description: 'Practical AI engineering guides and tutorials for software developers learning LLMs, RAG, prompt engineering, and machine learning.',
        publisher: { '@type': 'Organization', name: 'AI Learning Hub', url: 'https://ailearnings.in/' },
      },
      {
        '@context': 'https://schema.org',
